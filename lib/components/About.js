    ...
    <section>
      ...
      <article className="f4 lh-copy serif justify">
        <p>
          ...
          <a href="http://www.rescale.com/">Rescale</a>. I have deep interests
          in architecturing simple and scalable (as in complexity) systems, with
      ...
      <article className="f4 lh-copy serif justify">
        <p>
          ...
          can be found <a href="https://github.com/kentor/kentor.me">here</a>.
        </p>
      </article>
    </section>
  </Layout>
