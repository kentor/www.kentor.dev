    ...
    <section>
      ...
      <article className="f4 lh-copy serif justify">
        <p>
          ...
          at <a href="http://www.rescale.com/">Rescale</a>. I have deep
          interests in architecturing simple and scalable (as in complexity)
          systems, with a focus on developer experience.
        </p>
        <p>
      ...
      <article className="f4 lh-copy serif justify">
        <p>
          ...
          and <a href="https://github.com/kentor/tiny-ssg">tiny-ssg</a>.
          The source can be
          found <a href="https://github.com/kentor/kentor.me">here</a>.
        </p>
      </article>
    </section>
  </Layout>
